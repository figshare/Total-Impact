...
$(document).ready(function(){
	...
	<body>
		...
		<!-- START footer -->
			<p class="something-missing">More detail on <a href="./about.php#metrics">available metrics</a>.  Missing some artifacts or metrics? See <a href="./about.php#limitations">current limitations.</a>  </p>
